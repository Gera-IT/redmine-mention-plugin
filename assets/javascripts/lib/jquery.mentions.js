...
(function() {
  var MentionsBase, MentionsContenteditable, MentionsInput, Selection, entityMap, escapeHtml, namespace, settings,
  ...
  MentionsContenteditable = (function(_super) {
    ...
    mentionTpl = function(mention) {
      return "<span data-mention=\"" + mention.uid + "\">[~" + mention.uid + "]</strong>";
    };
